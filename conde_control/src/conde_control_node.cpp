...
void sensorCallback(const std_msgs::Float64MultiArray::ConstPtr& array)
{
    ...
    data[0] = array->data[0];       // Actual Distance
    data[1] = array->data[1];       // Actual Angle
    data[2] = array->data[2];       // Ref Vlinear
    data[3] = array->data[3];       // Ref Dist
    data[4] = array->data[4];       // Ref Angle
